...
TextTransformationDecorator::TextTransformationDecorator(LabelImpl *label, std::unique_ptr<Transformation> transformation_) : LabelDecoratorBase(label), transformation(std::move(transformation_)) {
